...
\[
\pi_{\text{Título\_de\_la\_Película, Año\_de\_Estreno}}(\text{Películas})
\]
...
\[
\pi_{\text{Director, Ciudad\_del\_Director}}(\text{Películas})
\]

**4. Selección: Filtrar películas estrenadas después de 2018**

\[
\sigma_{\text{Año\_de\_Estreno} > 2018}(\text{Películas})
\]

**5. Proyección y Selección: Obtener Títulos y Calificaciones de películas con calificación mayor a 8.0**

\[
\pi_{\text{Título\_de\_la\_Película, Calificación}}(\sigma_{\text{Calificación} > 8.0}(\text{Películas}))
\]
